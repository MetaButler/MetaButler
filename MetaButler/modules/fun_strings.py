...
RUN_STRINGS = (
    ...
    "You're a wizza- Oh. Wait. You're not Harry, keep moving.",
    ...
    "As The Doctor would say... GFY!",
)

SLAP_MetaButler_TEMPLATES = (
    "Slap me one more time and I'll gbang you.",
    "Stop slapping me. Beach.",
    [
        "I am muting you for a minute.",  # normal reply
        "Stop slapping me just because I can't gmute you.",  # reply to admin
        "gmute",  # command
    ],
)
