from MetaButler.modules.helper_funcs.decorators import metacallback
...
@metacallback(pattern=r"fmt_help_")
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="Back",
                        callback_data=f"help_module({__mod_name__.replace(' ', '_').lower()})",
                    ),
                    InlineKeyboardButton(
                        text="Report Error", url="https://t.me/MetaProjectsSupport"
                    ),
                ]
            ]
        ),
